...
const V_WIDE: PoseData = {
  torsoTilt: 0,
  leftUpperArm: -130, leftForearm: -150,
  rightUpperArm: 130, rightForearm: 150,
...
const TURN_MID: PoseData = {
  torsoTilt: -22,
  leftUpperArm: 35, leftForearm: 70,
  rightUpperArm: -30, rightForearm: -50,
...
const TAP_SIDE: PoseData = {
  ...
  leftThigh: 5, leftShin: 0,
  rightThigh: 42, rightShin: -25,
};

const ARMS_PUMP: PoseData = {
  torsoTilt: 3,
  leftUpperArm: -25, leftForearm: -40,
  rightUpperArm: 140, rightForearm: 160,
  leftThigh: 5, leftShin: 0,
  rightThigh: 5, rightShin: 0,
};
  ...
  // ─── 3. Basic Steps: V-Step ──────────────────────────────────────────
  {
    ...
    animation: {
      ...
      keyframes: [
        ...
        kf(0,    0.38, FY,   STAND),
        kf(900,  0.41, 0.54, R_LIFT),
        kf(1800, 0.46, TY,   WIDE_ARMS),
        // Phase 2: Left foot up, wide V position at top
        kf(2600, 0.49, 0.50, L_LIFT),
        kf(3500, 0.48, SY,   V_WIDE),
        // Phase 3: Hold wide, begin descent
        kf(4400, 0.48, SY,   WIDE_ARMS),
        kf(5200, 0.49, 0.51, R_REACH_DOWN),
        // Phase 4: Return to start
        kf(6200, 0.46, 0.53, SPLIT_RL),
  ...
  // ─── 7. Combinations: L-Step + Tap ───────────────────────────────────
  {
    ...
    animation: {
      ...
      keyframes: [
        ...
        kf(7800,  0.51, 0.50, R_REACH_DOWN),
        kf(8600,  0.48, 0.52, SPLIT_RL),
        kf(9400,  0.45, 0.54, L_REACH_DOWN),
        kf(10200, 0.42, 0.55, STAND),
        kf(11000, 0.40, FY,   STAND),
        kf(12000, 0.38, FY,   STAND),
      ],
    },
  },
  ...
  // ─── 8. Choreography: 8-Count Routine ────────────────────────────────
  {
    ...
    animation: {
      ...
      keyframes: [
        ...
        kf(6800,  0.41, 0.54, R_LIFT),
        kf(7600,  0.46, TY,   WIDE_ARMS),
        kf(8500,  0.48, SY,   V_WIDE),
        kf(9300,  0.48, SY,   WIDE_ARMS),
        kf(10200, 0.46, 0.53, SPLIT_RL),
        kf(11200, 0.41, 0.55, L_REACH_DOWN),
        kf(12000, 0.38, FY,   STAND),
      ],
    },
  },
  ...
  // ─── 9. Choreography: 32-Count Choreography ─────────────────────────
  {
    ...
    animation: {
      ...
      keyframes: [
        ...
        kf(4500,  0.40, 0.54, R_LIFT),
        kf(5000,  0.48, SY,   V_WIDE),
        kf(5500,  0.44, 0.53, SPLIT_RL),
        kf(6000,  0.38, FY,   STAND),
        kf(6500,  0.40, 0.54, L_LIFT),
        kf(7000,  0.48, SY,   V_WIDE),
        kf(7500,  0.42, 0.55, L_REACH_DOWN),
        kf(8000,  0.38, FY,   STAND),
